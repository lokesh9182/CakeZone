                    ...
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="d-flex flex-column justify-content-start">
                                <a class="text-secondary mb-2" href="welcome"><i class="bi bi-arrow-right text-primary me-2"></i>Home</a>
                                <a class="text-secondary mb-2" href="about"><i class="bi bi-arrow-right text-primary me-2"></i>About Us</a>
                                <a class="text-secondary mb-2" href="menu"><i class="bi bi-arrow-right text-primary me-2"></i>Our Cakes</a>
                                <a class="text-secondary mb-2" href="register"><i class="bi bi-arrow-right text-primary me-2"></i>Register</a>
                                <a class="text-secondary mb-2" href="contact"><i class="bi bi-arrow-right text-primary me-2"></i>Contact us</a>
                                <a class="text-secondary" href="login"><i class="bi bi-arrow-right text-primary me-2"></i>Login</a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
